		...
		<div id="collage_container" style="height: 80%;">
			...
			<div id="canvas" style="float:left; width:37%; height:91%;">
				...
				<div class="col-lg-12" id="mentBox" style = "margin-top:84%; width:100%; z-index:5">
					<textarea class="form-control" rows="2" id="ment" name="answr_contnt" placeholder="답변을 작성 해주세요!" 
					style="border:1px solid #e5e5e5; background-color:white; text-align: center; font-size:25px; " ></textarea>
				</div>
			</div>
