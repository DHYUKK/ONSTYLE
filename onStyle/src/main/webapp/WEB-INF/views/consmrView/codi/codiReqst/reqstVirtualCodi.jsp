...
<script src="/resources/consmr/codi/myDressRoom/js/virtualCodi.js?123"></script>	
		...
		<div id="collage_container" style="height: 80%;">
			...
			<div id="canvas" style="float:left; width:42%; height:91%;">
				...
				<div class="col-lg-12"  id="mentBox" style = "margin-top:75%; width:100%; z-index:5">
					...
					style="background-color:white; border:1px solid #e5e5e5; text-align: center; font-size: 25px;" ></textarea>
				</div>
			</div>
